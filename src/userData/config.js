const config = {
    "links": [
        "https://www.linkedin.com/in/jordanbharrison/",
        "https://github.com/JordanBHarrison",
        "https://www.pinterest.co.uk/jordanbh92/",
    ],
    "jobs": [
        {
            ...
            "roles": [
                {
                    ...
                    "summary": "Working as part of the Funding experience product team, building out functionality to allow users to apply and manage their applications for research funding in the pharmaceutical and scientific industry. This platform was built to replace the functionality of an existing “off the shelf“ software solution that Wellcome were previously using.",
                    "keypoints": [
        ...
        {
            "organisation": "GetGround",
            "website": "",
            "logo": "https://media.licdn.com/dms/image/C4E0BAQHN6A-Q_NWY3Q/company-logo_200_200/0/1673000095254?e=1692835200&v=beta&t=BIYmmsnr6HLQKlP3ygp4Skqj_WdoQFdHff5XUX9xXaE",
            ...
            "roles": [
                ...
                }, 
                {
                    ...
                    "keypoints": [
                        ...
                        "During my time on this team one project that we prototyped that was used by a large number of users was when we created a web application to allow users of Sky's OTT service (NowTv) to purchase and view the live Sky Sports Box Office stream for the Anthony Joshua vs. Dillian Whyte fight. Being a highly popular event this site had to support a very large concurrent user base but luckily went as smoothly as we could have wished for.",
                    ],
                    "from": "Dec 2014",
                    "to": "Mar 2016" 
                }
            ...
            "roles": [
                {
                    ...
                    "summary": "Working within a small (6-8 devs) team on Qube's 'Horizon' property management software to assist landlords in the management of their property portfolio. The legacy system built in C# required many bug fixes that were reported to us directly from the users. It was my team’s responsibility to create feature tickets, add them to the backlog and eventually plan when they are to be included within an upcoming sprint (due to the lack of a scrum master/product owner at the time). Although there was little in terms of challenging work coming into our team, it was very useful to learn the basic processes and ceremonies that come with working within a scrum team.",
                    "keypoints": [],
                    "from": "Sep 2014",
                    "to": "Dec 2014" 
                }
